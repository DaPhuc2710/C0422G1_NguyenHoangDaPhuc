...
public class Customer extends Person {
    ...
    public Customer(String name, LocalDate dOfb, String gender, int idNumber, int telephone, String email, String customerId, String typeOfCustomer, String address) {

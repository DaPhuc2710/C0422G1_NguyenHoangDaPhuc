...
public class               Employee extends Person {
    ...
    public Employee(String employeeId, String name, LocalDate dOfb, String gender, int idNumber, int telephone, String email, String acaLevel, String status, double wage) {
    ...
    public String getInForToCSVEmployee(){
        return getEmployeeId()+","+getName() + ","+getdOfb()+","+getGender()+","+getIdNumber()+","+getTelephone()+","+getEmail()+","+getAcaLevel()+","+getStatus()+","+getWage();
    }
}
